...
class Buff(Command):
    ...
    def main(self):
        buffs = [Key.DECENT_SPEED,Key.DECENT_BLESS,Key.DECENT_HOLY_SYMBOL,Key.DECENT_COMBAT,Key.HEAL, Key.CALL_OF_CYGNUS, Key.DECENT_SHARPEYES, Key.RIFT_OF_DAMNATION,Key.COSMIC_FORGE,Key.COSMOS,Key.SOUL_ECLIPSE]
        now = time.time()
